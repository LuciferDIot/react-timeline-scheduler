...
const basicTasks: any[] = [
    { id: "b1", label: "Project Kickoff", groupLabel: "Planning", groupId: "g1", startDate: generateDates(0, 3).start, endDate: generateDates(0, 3).end },
    ...
    { id: "b4", label: "UI Mockups", groupLabel: "Design", groupId: "g2", startDate: generateDates(9, 6).start, endDate: generateDates(9, 6).end },
    ...
    { id: "b8", label: "Frontend Development", groupLabel: "Engineering", groupId: "g3", startDate: generateDates(17, 12).start, endDate: generateDates(17, 12).end },
    ...
    { id: "b14", label: "Staging Deploy", groupLabel: "DevOps", groupId: "g6", startDate: generateDates(40, 2).start, endDate: generateDates(40, 2).end },
...
const darkTasks: any[] = [
    { id: "d1", label: "Research Phase", groupLabel: "Research", groupId: "dr1", startDate: generateDates(0, 6).start, endDate: generateDates(0, 6).end },
    { id: "d2", label: "Competitive Analysis", groupLabel: "Research", groupId: "dr1", startDate: generateDates(4, 5).start, endDate: generateDates(4, 5).end },
    ...
    { id: "d6", label: "User Testing", groupLabel: "Design", groupId: "dd1", startDate: generateDates(24, 4).start, endDate: generateDates(24, 4).end },
    ...
    { id: "d10", label: "Core Development", groupLabel: "Development", groupId: "de1", startDate: generateDates(25, 12).start, endDate: generateDates(25, 12).end },
    ...
    { id: "d15", label: "E2E Testing", groupLabel: "Testing", groupId: "dt1", startDate: generateDates(43, 4).start, endDate: generateDates(43, 4).end },
...
// COLORFUL TASKS - Each task has UNIQUE colors
const colorfulTasks: any[] = [
    {
        id: "c1", label: "Marketing Launch", groupLabel: "Marketing", groupId: "cm1",
        startDate: generateDates(1, 8).start, endDate: generateDates(1, 8).end,
        bgColor: "#10b981", borderColor: "#059669",
        extendedStyles: { backgroundColor: "#d1fae5" }
    },
    {
        id: "c2", label: "Social Media Campaign", groupLabel: "Marketing", groupId: "cm1",
        startDate: generateDates(9, 12).start, endDate: generateDates(9, 12).end,
        bgColor: "#f59e0b", borderColor: "#d97706",
        extendedStyles: { backgroundColor: "#fef3c7" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#fee2e2" }
    },
    {
        id: "c4", label: "Product Design", groupLabel: "Product", groupId: "cp1",
        startDate: generateDates(5, 9).start, endDate: generateDates(5, 9).end,
        bgColor: "#8b5cf6", borderColor: "#7c3aed",
        extendedStyles: { backgroundColor: "#ede9fe" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#dbeafe" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#fce7f3" }
    },
    {
        id: "c7", label: "Sales Kickoff", groupLabel: "Sales", groupId: "cs1",
        startDate: generateDates(2, 6).start, endDate: generateDates(2, 6).end,
        bgColor: "#6366f1", borderColor: "#4f46e5",
        extendedStyles: { backgroundColor: "#e0e7ff" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#cffafe" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#ffedd5" }
    },
    {
        id: "c10", label: "Frontend Sprint 1", groupLabel: "Engineering", groupId: "ce1",
        startDate: generateDates(10, 8).start, endDate: generateDates(10, 8).end,
        bgColor: "#84cc16", borderColor: "#65a30d",
        extendedStyles: { backgroundColor: "#ecfccb" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#ccfbf1" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#f3e8ff" }
    },
    {
        id: "c13", label: "QA Sprint 1", groupLabel: "Quality", groupId: "cq1",
        startDate: generateDates(18, 6).start, endDate: generateDates(18, 6).end,
        bgColor: "#f43f5e", borderColor: "#e11d48",
        extendedStyles: { backgroundColor: "#ffe4e6" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#e0f2fe" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#fef9c3" }
    },
    {
        id: "c16", label: "Infrastructure Audit", groupLabel: "DevOps", groupId: "cd1",
        startDate: generateDates(15, 7).start, endDate: generateDates(15, 7).end,
        bgColor: "#22c55e", borderColor: "#16a34a",
        extendedStyles: { backgroundColor: "#dcfce7" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#fed7aa" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#e9d5ff" }
    },
    {
        ...
        extendedStyles: { backgroundColor: "#fecdd3" }
    },
    {
        id: "c20", label: "SEO Optimization", groupLabel: "Content", groupId: "cc1",
        startDate: generateDates(19, 9).start, endDate: generateDates(19, 9).end,
        bgColor: "#38bdf8", borderColor: "#0ea5e9",
        extendedStyles: { backgroundColor: "#bae6fd" }
    },
];
