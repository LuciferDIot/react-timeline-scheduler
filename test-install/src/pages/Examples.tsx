...
export const Examples = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-[calc(100vh-64px)] overflow-hidden">
      {/* Sidebar */}
      <aside className="w-full lg:w-80 bg-[#111827] border-r border-white/10 flex-shrink-0 overflow-y-auto">
        <div className="p-6">
          ...
          <div className="space-y-2">
            {examples.map((ex) => (
              ...
              >
                ...
                {activeExampleId === ex.id && (
                    <p className="text-xs mt-1 text-blue-400/70 line-clamp-2">{ex.description}</p>
                )}
              </button>
            ))}
          </div>
